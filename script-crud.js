...
function createTask(tarefa) {
    ...
    button.addEventListener('click', (event) => {
        ...
        const inputData = document.querySelector('.data__input')
...
formTask.addEventListener('submit', (evento) =>{
    ...
    const inputData = document.querySelector('.data__input').value
    ...
    const task = {
            ...
            concluida: false,
            data: new Date(inputData + 'T00:00:00') 
        };

        const fusoHorarioLocal = task.data.getTimezoneOffset() * 60000;
        task.data = new Date(task.data.getTime() + fusoHorarioLocal);
